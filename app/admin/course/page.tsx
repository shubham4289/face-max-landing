      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
        ...
        <section style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 16 }}>
          ...
          >
            ...
            <input name="title" required placeholder="e.g. Basic Anatomy for Implantology"
            ...
            <input type="number" name="orderIndex" defaultValue={sections.length}
                   style={{ width: "100%", border: "1px solid #d1d5db", borderRadius: 8, padding: "10px 12px" }}/>
            <div style={{ height: 12 }}/>
            <button type="submit"
        ...
        <section style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 16 }}>
          ...
          >
            ...
            <input name="title" required placeholder="e.g. What is a dental implant?"
                   style={{ width: "100%", border: "1px solid #d1d5db", borderRadius: 8, padding: "10px 12px" }}/>
            <div style={{ height: 12 }}/>
            ...
            <input name="videoId" placeholder="e.g. 056ef4706ec54b21baa09deccbb710f7"
                   style={{ width: "100%", border: "1px solid #d1d5db", borderRadius: 8, padding: "10px 12px" }}/>
            <div style={{ height: 12 }}/>

            <label style={{ display: "block", fontWeight: 600, marginBottom: 6 }}>Duration (min) — optional</label>
            <input type="number" name="durationMin" defaultValue={0}
                   style={{ width: "100%", border: "1px solid #d1d5db", borderRadius: 8, padding: "10px 12px" }}/>
